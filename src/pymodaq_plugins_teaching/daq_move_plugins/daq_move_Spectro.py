...
class DAQ_Move_Spectro(DAQ_Move_base):
    ...
    stage_names = [] #.axis'  # "list of strings of the multiaxes
    ...
    def ini_stage(self, controller=None):
        ...
        try:
            ...
            if self.settings.child('multiaxes', 'ismultiaxes').value() and self.settings.child('multiaxes',
                ...
                #####################################
            # ajout du paramètre info
            self.settings.child('info').setValue(self.controller.infos)

            self.status.info = "Moc du spectrometer"
    ...
    def move_Abs(self, position):
        ...
        ## TODO for your custom plugin
        self.controller.set_wavelength(position, 'abs')
        self.emit_status(ThreadCommand('Update_Status',['Modification de la longueur d''onde']))
        ##############################
    ...
    def move_Rel(self, position):
        ...
        ## TODO for your custom plugin
        self.controller.set_wavelength(position, 'rel')
        self.emit_status(ThreadCommand('Update_Status',['move_rel - Some info you want to log']))
        ##############################
    ...
    def move_Home(self):
        ...
        ## TODO for your custom plugin
        pass
        self.emit_status(ThreadCommand('Update_Status',['move Home - not implanted']))
        ##############################
    ...
    def stop_motion(self):
      ...
      self.emit_status(ThreadCommand('Update_Status', ['stop motion - not implanted']))
